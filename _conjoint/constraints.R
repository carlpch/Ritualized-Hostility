...
attribute_list[["Previous provocations 1"]] <-  
  c("It is the first time that country B has done this provocation",
    "It is the third time that country B has done this provocation",
    "It is the fifth time that country B has done this provocation",
    "It is the seventh time that country B has done this provocation",
    "It is the ninth time that country B has done this provocation",
    "It is the eleventh time that country B has done this provocation")
...
constraint_list[[3]][["Previous provocations 1"]] <- c("It is the first time that country B has done this provocation")
...
constraint_list[[4]][["Previous provocations 1"]] <- c("It is the third time that country B has done this provocation")
constraint_list[[4]][["Previous provocations 2"]] <- c("&nbsp;")
#5
constraint_list[[5]] <- list()
constraint_list[[5]][["Previous provocations 1"]] <- c("It is the fifth time that country B has done this provocation")
constraint_list[[5]][["Previous provocations 2"]] <- c("&nbsp;")
#7
constraint_list[[6]] <- list()
constraint_list[[6]][["Previous provocations 1"]] <- c("It is the seventh time that country B has done this provocation")
constraint_list[[6]][["Previous provocations 2"]] <- c("&nbsp;")
#9
constraint_list[[7]] <- list()
constraint_list[[7]][["Previous provocations 1"]] <- c("It is the ninth time that country B has done this provocation")
constraint_list[[7]][["Previous provocations 2"]] <- c("&nbsp;")
#11
constraint_list[[8]] <- list()
constraint_list[[8]][["Previous provocations 1"]] <- c("It is the eleventh time that country B has done this provocation")
constraint_list[[8]][["Previous provocations 2"]] <- c("&nbsp;")


ritualdesign <- makeDesign(type='constraints', attribute.levels=attribute_list,
